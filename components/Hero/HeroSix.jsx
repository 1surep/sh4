          ...
          <div className="absolute inset-0 flex items-center justify-center">
           ...
           <div className="absolute inset-0 z-20 p-8 md:p-16">
             ...
             <div className="md:hidden grid grid-cols-1 gap-8 h-full overflow-y-auto">
               ...
               <div className="absolute inset-0 bg-black/30 z-[1]" aria-hidden="true"></div>
             ...
             aria-hidden="true"/>
               ...
               <div className="absolute top-16 left-16 max-w-xs z-10">
                 <div className="text-gray-50 text-7xl font-bold mb-2">01.</div>
                 <div className="text-[#f9b84f] text-3xl font-semibold italic mb-3">Be Healthy</div>
                 <div className="w-16 h-0.5 bg-gray-50 mb-4"></div>
                 <p className="text-base leading-relaxed text-gray-50 z-10">
                    To promote physical fitness amongst it's members.
                 </p>
               </div>
               ...
               <div className="absolute bottom-16 left-16 max-w-xs z-10">
                 <div className="text-gray-50 text-7xl font-bold mb-2">02.</div>
                 <div className="text-[#f9b84f] text-3xl font-semibold italic mb-3">Be Strong</div>
                 <div className="w-16 h-0.5 bg-gray-50 mb-4"></div>
                 <p className="text-base leading-relaxed text-gray-50 z-10">
               ...
               <div className="absolute top-16 right-16 max-w-xs text-right z-10">
                 <div className="text-white text-7xl font-bold mb-2">03.</div>
               ...
               <div className="absolute bottom-16 right-16 max-w-xs text-right z-10">
                 <div className="text-white text-7xl font-bold mb-2">04.</div>
