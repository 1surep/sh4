            ...
            <section className="min-h-screen pt-28 flex items-center justify-center bg-black relative" onMouseMove={onMove} onMouseLeave={resetTilt}>
                ...
                >
                    ...
                    <div className="lg:mt-3 mt-10 flex items-center justify-center gap-4">
                        <a href="#about" className="btn btn-primary bg-green-500 hover:bg-green-700 hover:text-gray-100 text-gray-900 active:bg-green-800 active:text-white md:active:bg-green-700 md:active:text-gray-100">Join The Adventure</a>
