  ...
  return (
    <>
      <section>
        ...
        <div 
        id="game"
        className="bg-yellow-50 flex items-center justify-center py-12 px-[1rem] lg:px-[3rem] w-full">
          ...
          <section className="relative flex flex-col items-center justify-center py-10 bg-white overflow-hidden">
            ...
            <div className="relative text-center">
              ...
              <div>
                ...
                {/* Game Modal */}
                {showGame && (
                  <div className="fixed mt-24 inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-md">
