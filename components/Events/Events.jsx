            ...
            {events.map((event, index) => (
              ...
              >
                ...
                <div className="bg-gray-100 p-8 flex flex-col gap-3 flex-grow justify-between">
                  ...
                  <Link
                    href={"/event"}
                    className="mt-4 flex items-center border-2 border-[#f9b84f] px-4 py-2 rounded-lg hover:bg-[#f9b84f] hover:text-white transition-all duration-500 ease-in-out gap-2 text-[#f9b84f] cursor-pointer font-bold w-fit"
                  >
                    Read More...
